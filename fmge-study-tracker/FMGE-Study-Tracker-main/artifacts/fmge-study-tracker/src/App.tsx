...
import { loadAppState, saveAppState, calculateAppStats, deduplicateQuestions, deduplicateAnnouncements } from './utils/storage';
...
export function App() {
  ...
  const [aiCoachInitialTab, setAiCoachInitialTab] = useState<'vignette' | 'concept' | 'diagnosis'>('vignette');
  ...
  const handleOpenAiCoach = (tab: 'vignette' | 'concept' | 'diagnosis' = 'vignette') => {
