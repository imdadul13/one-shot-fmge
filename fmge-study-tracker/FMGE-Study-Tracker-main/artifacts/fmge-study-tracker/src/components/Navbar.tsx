...
export type ActiveTab = 'dashboard' | 'syllabus' | 'revision' | 'grandtests' | 'daily' | 'pearls' | 'telegram';
      ...
      <div className="workspace-nav overflow-hidden rounded-[1.35rem] border border-[#cfe2df] bg-[#fffefd]/95 shadow-xs backdrop-blur-xl">
        <div className="flex flex-wrap items-center justify-between gap-3 px-4 py-3 sm:px-5">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#e3f0ee] text-[11px] font-bold text-[#16727a]" data-testid="text-user-initials" title={userName || 'Doctor'}>
              {initials || 'DR'}
            </div>
          </div>
        </div>
