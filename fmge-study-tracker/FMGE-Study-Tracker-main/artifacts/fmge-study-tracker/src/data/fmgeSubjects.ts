...
export const FMGE_SUBJECTS: FMGESubject[] = [
  ...
  },
  {
    ...
    code: 'MED',
    phase: 'clinical',
    weightage: 33, // Mega clinical subject!
    color: '#ec4899', // Pink
    ...
    highYieldTips: 'MEGA HIGH YIELD (33 Marks). Must master ECG abnormalities, Diabetes guidelines, Stroke syndromes, Chronic kidney disease staging, Heart Failure management, and Shock.',
    topics: [
      ...
      { id: 'med-2', name: 'Cardiology - Valvular Heart Diseases & Infective Endocarditis (Duke Criteria)', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-3', name: 'Cardiology - Heart Failure (HFrEF/HFpEF) & Hypertension Guidelines', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-4', name: 'Pulmonology - Asthma vs COPD Guidelines (GOLD staging & inhalers)', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-5', name: 'Pulmonology - Pneumonia (CURB-65) & Pulmonary Embolism (Wells Score)', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-6', name: 'Neurology - Stroke Localizations (MCA, ACA, PCA, Vertebrobasilar)', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-7', name: 'Neurology - Epilepsy, Status Epilepticus & Headaches', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-8', name: 'Neurology - Movement Disorders, Parkinsonism & Meningitis/Encephalitis', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-9', name: 'Nephrology - Acute Kidney Injury (KDIGO) & Chronic Kidney Disease', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-10', name: 'Endocrinology - Diabetes Mellitus (Diagnostic criteria, DKA, HHS, OHA)', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-11', name: 'Endocrinology - Thyroid (Graves, Hashimoto) & Adrenal Disorders (Cushing/Addison)', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-12', name: 'Gastroenterology - Cirrhosis, Ascites (SAAG), Portal HTN & IBD (Crohn vs UC)', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-13', name: 'Rheumatology - SLE, Rheumatoid Arthritis, Scleroderma & Vasculitis', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false },
      { id: 'med-14', name: 'Infectious Diseases - Dengue, Malaria, Typhoid, Leptospirosis & HIV', isHighYield: true, notesDone: false, qBankDone: false, r1Done: false, r2Done: false, r3Done: false }
    ]
  },
  {
    id: 'surgery',
    ...
    code: 'SURG',
    phase: 'clinical',
    weightage: 32, // Mega clinical subject!
    color: '#f43f5e', // Rose
    iconName: 'Scissors',
    description: 'Trauma & ATLS, Shock & Burns, Breast, Thyroid, GI Surgery, Hernia, Vascular, and Urology.',
    highYieldTips: 'MEGA HIGH YIELD (32 Marks). Must master Parkland formula for Burns, ATLS trauma resuscitation, Thyroid carcinoma management, Colorectal staging, and Hernia repairs.',
    topics: [
